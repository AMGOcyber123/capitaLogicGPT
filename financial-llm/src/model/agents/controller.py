...
from langchain.agents import AgentExecutor, LLMSingleActionAgent  # type: ignore
from langchain.chains.base import Chain # type: ignore
from langchain.llms import BaseLLM  # type: ignore
from langchain.memory import ConversationBufferWindowMemory, ReadOnlySharedMemory  # type: ignore
...
class CaptiaLogicGPT(Chain, BaseModel):
    ...
    advisor_name: str = "Harshad Mehta"
    advisor_role: str = "Investment service advisor"
    nationality: str = "Indian"
    formal_language: str = "english"
    informal_language: str = "english"
    company_name: str = "Abrdn"
    ...
    def from_llm(
        ...
        """Initialize the CaptiaLogicGPT Controller."""
